...
void main() {
  group('NdArray Addition (operator+)', () {
    ...
    testBroadcastingAddition3DWith2D();
    testBroadcastingAdditionMultipleOnes();
    testBroadcastingAdditionWithSteppedView();
  });
}
...
void testBroadcastingAddition3DWith2D() {
  test('Broadcasting Addition: 3D[2, 2, 3] + 2D[2, 3]', () {
...
void testBroadcastingAdditionMultipleOnes() {
  test('Broadcasting Addition: Multiple Ones [4, 1, 3] + [1, 5, 1]', () {
    ...
    var expectedData = List.generate(4, (i) {
      return List.generate(5, (j) {
        return List.generate(3, (k) {
          // Use NdArray indexing instead of direct data access
          int aVal = a[[i, 0, k]];
          int bVal = b[[0, j, 0]];
          return aVal + bVal;
        });
...
void testBroadcastingAdditionWithSteppedView() {
  test('Broadcasting Addition: Array[2, 3] + SteppedView[3]', () {
    var a = NdArray.array([
      [1, 2, 3],
      [4, 5, 6]
    ]);
