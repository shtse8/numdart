...
void main() {
  group('NdArray reshape tests', () {
    test('Reshape 1D to 2D', () {
      var a = NdArray.arange(6); // Use static method
      var b = a.reshape([2, 3]);
    ...
    test('Reshape with -1 dimension inference', () {
      var a = NdArray.arange(12); // Use static method
    ...
    test('Reshape scalar (size 1)', () {
      var a = NdArray.array([5]); // Use static method
      ...
      var c = NdArray.zeros([]); // Use static method
    ...
    test('Reshape empty array (size 0)', () {
      var a = NdArray.array([]); // Use static method
      var b = a.reshape([0, 5]);
      expect(b.shape, equals([0, 5]));
      expect(b.ndim, equals(2));
      expect(b.size, equals(0));

      var c = NdArray.zeros([5, 0]); // Use static method
      var d = c.reshape([0]);
    ...
    test('Reshape view modifies original', () {
      var a = NdArray.arange(4); // Use static method
