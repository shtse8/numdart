...
// No 'part of' needed for standalone test files

void main() {
  // Main entry point for this test file
  group('NdArray tan', () {
    // Call individual test functions directly within the group
    testTanSimpleCalculation();
    testTanOfIntegers();
    testTanOfDoubles();
    testTanOfMultiDimensionalArray();
    testTanOfEmptyArray();
    testTanNearPiOver2();
  });
}

void testTanSimpleCalculation() {
  test('simple tan calculation', () {
    ...
    expect(result.dtype, equals(double)); // Compare with primitive type double
...
void testTanOfMultiDimensionalArray() {
